...
const guillaume = {
    ...
    superpower: "Turning complex ideas into scalable, production-ready systems",
    motto: "Ship fast. Scale smart. Never stop building."
};
```
...
- 🧠 **AI Integration** — Shipping intelligent features that solve real problems
- 📈 **Scale Obsession** — Architecting systems that handle millions of requests
- ⚡ **Performance** — Making things faster is my happy place
...
| 🏆 Achievement | 📊 Impact |
|:---|:---|
| **Built 3 AI products solo** | Concept → Production, full-stack ownership |
| **Optimized high-traffic APIs** | **40% faster** response times |
| **Cloud migration (Azure → AWS)** | Reduced costs & improved latency |
| **Millions of daily requests** | Architected systems that never break |
| **Serverless at scale** | Thousands of concurrent calls handled |
...
2023 ──────── 🌍 Senior Python Engineer @ blackshark.ai (Cloud & Backend optimization)
     │
2022 ──────── 💻 Freelance Senior Engineer @ Volteras / Helloprint
     │
2020 ──────── ☁️ Software Engineer @ OVHcloud (Core cloud infrastructure)
     │
2020 ──────── 🎓 Master's in Computer Engineering @ EPITECH
```
...
![French](https://img.shields.io/badge/🇫🇷_French-Native-4F46E5?style=for-the-badge)
![English](https://img.shields.io/badge/🇬🇧_English-Fluent-3B82F6?style=for-the-badge)
![Spanish](https://img.shields.io/badge/🇪🇸_Spanish-Intermediate-10B981?style=for-the-badge)
![German](https://img.shields.io/badge/🇩🇪_German-Basic-F59E0B?style=for-the-badge)
...
🤺 **Fencing** • 🥾 **Hiking** • ♟️ **Chess** • 🚴 **Cycling** • 🏃 **Marathon**
...
[![LinkedIn](https://img.shields.io/badge/Connect_on_LinkedIn-0A66C2?style=for-the-badge&logo=linkedin&logoColor=white)](https://www.linkedin.com/in/guillaume-demay/)
[![Email Me](https://img.shields.io/badge/Send_an_Email-EA4335?style=for-the-badge&logo=gmail&logoColor=white)](mailto:guillaumedemay@hotmail.fr)

<br/>

<img src="https://komarev.com/ghpvc/?username=GDemay&color=6366F1&style=for-the-badge&label=Profile+Views"/>
